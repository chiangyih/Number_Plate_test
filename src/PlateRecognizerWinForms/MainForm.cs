...
public sealed class MainForm : Form
{
    ...
    private void Recognize()
    {
        ...
        _txtResult.Text = result.PlateText;
        _txtLog.Text = string.Join(Environment.NewLine, result.DebugLogs);

        _picPlate.Image?.Dispose();
        _picPlate.Image = result.PlateImage is null ? null : BitmapConverter.ToBitmap(result.PlateImage);
